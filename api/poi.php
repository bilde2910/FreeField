...
if ($_SERVER["REQUEST_METHOD"] === "GET") {
    include(__DIR__."/../includes/api/poi/list.php");
} elseif ($_SERVER["REQUEST_METHOD"] === "PUT") {
    include(__DIR__."/../includes/api/poi/add.php");
    ...
    */
    ...
    if (isset($patchdata["objective"]) && isset($patchdata["reward"])) {
        include(__DIR__."/../includes/api/poi/report.php");
    } elseif (isset($patchdata["move_to"])) {
        include(__DIR__."/../includes/api/poi/move.php");
    ...
    include(__DIR__."/../includes/api/poi/delete.php");
} else {
